...
const Supplier = () => {
   ...
   const getAllWarehouse = useCallback(async () => {
      const res = await axios.get(
         `suppliers?page=${page}&sort=${sort.sort},${sort.order}&search=${search}`
      );
   ...
   const handleDeleteWarehouse = async (warehouseId) => {
      try {
         const res = await axios.delete(`suppliers/${warehouseId}`);
   ...
   return (
      <>
         ...
         <div className="bg-white px-4 pt-3 pb-4 rounded-sm border border-gray-200 flex-1">
            <strong className="text-gray-700 font-medium">Nhà cung cấp</strong>
